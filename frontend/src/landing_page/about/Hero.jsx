  ...
  return (
    <div className="container mt-5">
      <div className="row p-5 mb-5 border-bottom">
        <h1 className="fs-4  lh-base text-center text-muted my-5">
          We pioneered the discount broking model in India. <br /> Now, we are
          breaking ground with our technology.
        </h1>
      </div>

      <div className="row mt-5 mb-5 fs-6 text-muted">
        <div className="col pt-5  ms-5">
          <p className="lh-lg ms-5">
        ...
        <div className="col p-5 p-5 me-5 text-start">
          <p className="lh-lg">
